...
namespace UiC.NetworkServer.Network
{
    public class BaseClient : IClient, IDisposable
    {
        ...
        private SemaphoreSlim m_semaphore = new SemaphoreSlim(500, 500);
        ...
        public TeknoServer TeknoServer
        {
            get;
            set;
        }
        ...
        {
            ServerPacketHandler.Instance.Dispatch(this, message);
